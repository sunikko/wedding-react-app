...
interface FullScrrenMessageProps {
  type: 'loading' | 'error' | 'success'
}

function FullScrrenMessage({ type }: FullScrrenMessageProps) {
  return (
    <div className={cx('container')}>
      {type === 'loading' ? (
        ...
        <>
          <Error />
          There's an error occurred. Please try again.
        </>
      )}
    </div>
  )
...
export default FullScrrenMessage
